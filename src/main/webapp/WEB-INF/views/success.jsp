...
<body class="background">
	...
	<div  align="center" class="section">
		...
		<td width="50%;">
			...
			Please have a look at the information we collected from you.
			Your email is private, everything else can be discovered by everyone.
			<br><br>
			But there's currently nothing to
			look at right now, the only thing you can do is...
